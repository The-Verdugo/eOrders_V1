<%@ Page Title="Inbox de e-Orders" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Inbox.aspx.vb" Inherits="eOrder.Contact" %>
...
<div class="container">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-3">
     ...
     <asp:ListBox ID="LstAnioMes" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="LstAnioMes_SelectedIndexChanged"></asp:ListBox>
    </div>
  </div>
            <div class="form-row">
